class RurumMessenger {
    constructor() {
        ...
        // Ably настройки - ВАЖНО: В продакшене используйте серверную аутентификацию!
        this.ably = null;
        this.channel = null;
    ...
    // ДОБАВЛЕННЫЙ МЕТОД: Присоединиться к тестовому чату
    joinTestChat() {
    ...
    // ОБНОВЛЕННЫЙ МЕТОД: Создание нового чата
    createNewChat() {
    ...
    // ОБНОВЛЕННЫЙ МЕТОД: Начать чат с другом
...
// Тестовая функция для быстрого доступа
window.joinTest = () => {
