class RurumMessenger {
    constructor() {
        ...
        this.ably = null;
        this.channel = null;
        this.ABLY_API_KEY = 'AcL67w.nyZ_5A:J4JyAk0k9idP-77-GRCp6No-lbfpF2UG0peFaC-9qSg'; // УДАЛИТЕ ЭТОТ КЛЮЧ! Вставьте свой валидный ключ Ably
    ...
    init() {
        ...
        // Инициализируем Ably (будет работать только с валидным ключом)
        if (this.ABLY_API_KEY && this.ABLY_API_KEY.length > 10) {
            this.initAbly();
        } else {
            console.warn('⚠️ Ably API key not provided. Real-time messaging disabled.');
    ...
    initAbly() {
        try {
            ...
            if (typeof Ably === 'undefined') {
                ...
                this.showMessage('Библиотека Ably не загружена', 'error');
                return;
            }
    ...
    createNewChat() {
        ...
        let chat = this.chats.find(c => c.name === chatName);
